...
Revision ID: aa6c34f9961d
Revises: 
Create Date: 2024-12-11 20:52:07.325639
...
def upgrade() -> None:
    ...
    op.drop_table('authorsapp_author')
    ...
    op.drop_index('authorsapp_quote_author_id_dd812b28', table_name='authorsapp_quote')
    op.drop_table('authorsapp_quote')
...
def downgrade() -> None:
    ...
    op.create_table('authorsapp_quote',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('tags', postgresql.ARRAY(sa.VARCHAR(length=30)), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['author_id'], ['authorsapp_author.id'], name='authorsapp_quote_author_id_dd812b28_fk_authorsapp_author_id', initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name='authorsapp_quote_pkey')
    )
    op.create_index('authorsapp_quote_author_id_dd812b28', 'authorsapp_quote', ['author_id'], unique=False)
    ...
    op.create_table('authorsapp_author',
    sa.Column('id', sa.BIGINT(), sa.Identity(always=False, start=1, increment=1, minvalue=1, maxvalue=9223372036854775807, cycle=False, cache=1), autoincrement=True, nullable=False),
    sa.Column('fullname', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('born_date', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('born_location', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='authorsapp_author_pkey')
    )
